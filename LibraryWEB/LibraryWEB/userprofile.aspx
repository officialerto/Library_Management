<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="LibraryWEB.userprofile" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox class="form-control" ID="TextBox8" runat="server" placeholder=" " ReadOnly="True"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                           <h4>Verdiğiniz Kitaplar</h4>
                           <asp:Label class="badge badge-pill badge-info" ID="Label2" runat="server" Text="Kitap Bilgileriniz"></asp:Label>
                        </center>
                            </div>
                        </div>
                        <div class="row">
